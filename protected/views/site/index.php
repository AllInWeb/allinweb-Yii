...
<head>
    ...
    <!--[if IE]>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.infinitecarouselExplorer.js"
            type="text/javascript"></script>
    <![endif]-->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery-mousewheel-3.1.12/jquery.mousewheel.js"
            type="text/javascript"></script>
    ...
    <script type="text/javascript"
            src="<?php Yii::app()->getBasePath(); ?>/js/placeholder/jquery.placeholder.js"></script>
...
<div id="single">
    ...
    <div id="bottom-footer">
        ...
        <div id="foot">
            <span id="all-in-web">© All in Web 2014</span>
                <span id="links">
                    <a href="#"><img src="/images/parts/tw-icon.png"></a>
                    <a href="#"><img src="/images/parts/fb-icon.png"></a>
                    <a href="#"><img src="/images/parts/vk-icon.png"></a>
