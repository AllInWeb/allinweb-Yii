...
<head>
   ...
   <!-- <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery-1.9.1.min.js" type="text/javascript"></script> -->
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.hoverizr.js"></script>
...
<div id="mainmenu">
        ...
        <div id="menu">
            <ul class="menu">
                ...
                <li><a href="/yii/project/index.php?r=#">Портфолио</a></li>
                <li><a href="/yii/project/index.php?r=#">Тарифы</a></li>
                <li><a href="/yii/project/index.php?r=#">FAQ</a></li>
